...
\newcommand*\esf[0]{\mathbf{E}_S(f)} % Analogical extension
\newcommand*\esfs[0]{\mathbf{E}_S^*(f)} % Analogical extension star
\newcommand*\aroot[3]{\mathbf{R}_{#1}(#2, #3)} % Analogical root
\newcommand*\rsfx[0]{\mathbf{R}_S(f, \mathbf{x})} % Analogical extension
