...
by algorithm \ref{ALGO:bruteforce}, and referred to as \textit{Bruteforce}.

 \begin{algorithm}[!ht]
   \caption{\textit{A bruteforce algorithm for clone-based recommendation.}}
...
can lead to better results than a basic neighborhood method, as we will see
later.
