...
relevant recommendations. They are mostly used in an implicit rating scheme,
and are strongly linked to the number of true postives, true negatives, false
positives and false negatives. They can also be used when the rating scale is
gradual, but the recommendation strategy has to be clearly defined.
