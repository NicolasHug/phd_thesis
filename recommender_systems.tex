...
movies cannot be described using the same set of features (even though they are
...
$r_{ui}'$ is an implicit rating stating that $u$ has rated $i$, regardless of
the rating value.
...
adding the ability to incorporate implicit ratings along with explicit ones,
