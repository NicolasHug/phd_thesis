...
considered (see \cite[Ch. ??]{RecoSystemHandbook} for an extensive survey).
% Obviously
...
into $k$ disjoint sets ; at each of the $k$ iterations, $\Rtrain$ is set to the
$k^{\text{th}}$ subset and $\Rtest$ is set as the $k - 1$ remaining ones. The
reported performances are then the average of the $k$ measures.
