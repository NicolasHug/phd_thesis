...
the previous sections. The Movielens-1A dataset was not benchmarked, because
...
Fraction of Concordant Pairs, which evaluates the probability that given any two
...
intermediate measures. Following the notation of \ref{TODO}, $c_u$ defines the
number of concordant pairs for user $u$, and $d_u$ its number of discordant
...
\begin{itemize}
  ...
  \item Another option for the gradual rating scale is to use the definitions
    of fuzzy analogy of section \ref{TODO}\todo{completer}. When the quality
