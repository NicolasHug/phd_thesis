...
\toprule
  ...
  \midrule
    Star Wars & The Empire Strikes Back & Raiders of the Lost Ark & Return of the Jedi  \\
Star Wars & Return of the Jedi & Raiders of the Lost Ark & The Empire Strikes Back  \\
Star Wars & The Empire Strikes Back & Return of the Jedi & Raiders of the Lost Ark  \\
Star Wars & Raiders of the Lost Ark & Return of the Jedi & I.J. and the Last Crusade  \\
Star Wars & Return of the Jedi & Raiders of the Lost Ark & The Fugitive  \\
Star Wars & Raiders of the Lost Ark & Return of the Jedi & Back to the Future  \\
Star Wars & The Empire Strikes Back & Raiders of the Lost Ark & I.J. and the Last Crusade  \\
Star Wars & The Empire Strikes Back & Return of the Jedi & I.J. and the Last Crusade  \\
Star Wars & The Empire Strikes Back & I.J. and the Last Crusade & Return of the Jedi  \\
Star Wars & Raiders of the Lost Ark & The Empire Strikes Back & The Fugitive\\
\bottomrule
\end{tabular}
\caption{The ten best item proportions with a support of more than $200$ common
  ratings.}
\label{TAB:ten_best_proportions}
\end{table}
...
Jones\dots) are extremely popular.

Some of the analogies are actually really good. For example the fourth one
\textit{Star Wars (1977)} is to \textit{Raiders of the Lost Ark (1981)} as
...
$i_1:i_2::i_3:i_4$ and $i_1:i_2::i_4:i3$ are present in the table. These two
...
$r:r::r:r$, suggesting that people like all these movies the same.

To try to discover some more surprising analogies, we have two options. The
first one is to lower the minimum support threshold, to allow movies that are
rated by a reasonable (and not necessarily very high) number of users. As we
have seen, movies with a very high number of ratings are likely yo lead to
trivial proportions precisely because they are popular, and because people like
them all equally well. If we really want to ban popular movie, we can also set
a \textbf{maximum} support threshold, which will have the benefit to limit the
number of itemsets that we consider, thus leading to significant performance
improvements.  The second option is to tweak a bit our quality function $f$
(and in our case, our comparison function) by penalizing proportions whose
pattern is $r:r::r:r$. 
...
directmeent plutôt que de se faire chier avec l'analogie.
