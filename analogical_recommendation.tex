...
before, but instead of predicting a rating, we output a predicted rank. This
...
recommendation in Section \ref{SEC:clone_based_view}. Acknowledging the fact that each user tends to have its very
