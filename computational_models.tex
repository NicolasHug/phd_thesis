...
\end{table}
We already acknwoledge here a mapping between two domains: a source domain (the
...
have hoofs is however fairly irrelevent for the matter. Finally, the \textbf{no
...
meanings), and seems to be in accordance with Hesse's requirement of material
analogy. Second, this theory also involves the pragmatic considerations of the
human agent: the goal and purpose of the analogist should somehow guide the
mapping process in some direction or another. Mappings that serve the purpose
of the agent are therefore given higher priority than others.
...
the merit of requiering to inspect the source $S$, at least in the first step
of the process.
