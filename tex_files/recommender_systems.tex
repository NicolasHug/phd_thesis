...
recommendation session, where the users indicate their needs in an interactive
...
recommendation, we will detail the recommendation problem that will be
...
to estimate their tastes for the items that the system provides. The taste of a
...
In practice, we know how to compute the the two matrices $U$ and $I$: their
columns are are the
...
factors which indicates how strong are is taste of $u$ for the given factors.
