...
analogical reasoning are often mixed up in the litterature.  We choose to
...
:: P_{i_3} : P$, and the solution $S$ will be inferred by the
\textit{extrapolating}\footnote{The way $S$ is \textit{extrapolated} will be
described in the next chapter as the \textbf{solving} of the analogical
equation.} $S$ from the associated equations: $S_{i_1} : S_{i_2} :: S_{i_3} :
