...
\makesomeone{judge}{2}{Hélène Fargier}{Directeur de recherche}{Examinateur}
...
\makesomeone{judge}{5}{Henri Prade}{Directeur de recherche}{Examinateur}
\makesomeone{judge}{6}{Gilles Richard}{Professeur}{Directeur de thèse}
\makesomeone{judge}{7}{Agn\`es Rico}{Ma\^itre de conférences}{Examinateur}
\makesomeone{judge}{8}{Mathieu Serrurier}{Ma\^itre de conférences}{Directeur de
thèse}
\makesomeone{judge}{9}{François Yvon}{Professeur}{Examinateur}
...
\pdfinfo{
   /Author (Nicolas Hug)
   /Title (Contributions to the use of analogical proportions for machine
   learning: Theoretical properties and application to recommendation.)
