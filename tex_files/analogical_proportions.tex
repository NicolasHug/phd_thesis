...
mare'', or ``Paris is to France as Berlin is to Germany''.  As relation
...
or what is not both in $x$ and $y$. Conversely, a dissimilarity indicator $I(x,
...
logical proportions in this document (except the analogical proportion of
...
\implies A(c, d, a, b)$, and the central permutation axiom states that $A(a, b,
c, d) \implies A(a, c, b, d)$.}, we arrive to the following $8$ equivalent
proportions:
\begin{align*}
       &A(a, b, c, d)\\
