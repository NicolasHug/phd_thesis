...
reasoning to real-worl problems}.
...
standard artificial settings. To our knowledge, the analogical leaners were yet
...
analogical recommandation are strongly inspired by previous works on analogical
...
This document is structed as follows.\\
...
by cognitive and psychological aspects, which is in constrast to our main
...
collaborative nature, we will thoroughy detail two popular methods for
...
preliminarly investigations, which are a direct adaptation of the analogical
...
Acknowledging this fact, we developped another view of analogical
recommandation, taking into account the fact that some users may have different
...
database \cite{HugPraRicSerLFA16}. Our result will help us to restrospectively
...
inference principle states that if four elements $a, b, c, d$ are in propotion,
then their classes $f(a), f(b), f(c), f(d)$ should also be in proprtion. We
