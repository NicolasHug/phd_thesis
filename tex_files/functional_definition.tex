...
thus have $\mathbf{C}(\mathbf{g}) = \Set{1, 1}$: one solution that comes from the
  solving of
...
proved in Chapter \ref{CHAP:analogy_preserving_functions}. Let us now focus on
their VC-dimension.
...
\begin{definition}[VC-dimension]
  ...
  The VC-dimension of $\mathcal{C}$ is the biggest $n$ such that there exists a
