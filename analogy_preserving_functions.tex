...
used. Even if this argument is perfectly admissible, we will not spare ourselves
...
a set $S$ of points (on the left) that belong to two classes that are linearly
...
in $S^3$ (i.e. the element is the fourth vertex of a parallelogram that we can
...
This one is the inference principle that is actually useful in practice: if the
